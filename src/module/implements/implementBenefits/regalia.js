    ...
    const regaliaRules = [
      {
        ...
        value: 1,
        type: "circumstance",
        label: "pf2e-thaum-vuln.implements.regalia.ruleElements.initiate",
      ...
      },
      {
        ...
        label: "pf2e-thaum-vuln.implements.regalia.ruleElements.auraInitiate",
      ...
      },
      {
        ...
        traits: ["emotion", "mental", "visual"],
        label: "pf2e-thaum-vuln.implements.regalia.ruleElements.auraAdept",
      ...
      },
      {
        ...
        traits: ["emotion", "mental", "visual"],
        label: "pf2e-thaum-vuln.implements.regalia.ruleElements.auraParagon",
      ...
      },
      {
        ...
        value: 2,
        type: "circumstance",
        label: "pf2e-thaum-vuln.implements.regalia.ruleElements.adept",
        predicate: [
